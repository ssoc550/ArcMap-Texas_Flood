...
# bldg_ftprt = 
# Tara's
bldg_ftprt = r'S:\GEOG_6308.80_Programming_Geospatial_202001\Seibold,Tara-TSeibold\Final_Project\texas_shape\god_help_us.shp'
...
fld_dpth_ras = Reclassify(in_raster = fld_dpth_ras, reclass_field = "Value", remap = RemapRange([[-1000, 0, 0], [0.01, 1, 1], [1.01, 2, 2], [2.01, 3, 3],[3.01, 4, 4], [4.01, 44, 5]]), missing_values = "NODATA")
...
arcpy.Statistics_analysis(in_table = "bldg_subset", out_table = "total_damage_table", statistics_fields =["tot_dmg", "SUM"])
